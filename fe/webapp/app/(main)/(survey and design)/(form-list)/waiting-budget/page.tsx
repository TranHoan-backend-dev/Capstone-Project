...
import { generateMockDataWaitingBudget } from "@/lib/mockData";

const ReportWaitingList = () => {
  const [searchQuery, setSearchQuery] = useState("");
  const mockData = useMemo(() => generateMockDataWaitingBudget(20), []);

  const breadcrumbs = [
    { label: "Trang chủ", href: "/home" },
    { label: "Khảo sát thiết kế", href: "#" },
    { label: "Báo cáo", href: "#" },
    { label: "Danh sách đơn chờ dự toán", isCurrent: true },
  ];
  ...
  return (
    <>
      ...
      <div className="pt-2">
        {/* <FilterForm title="Danh sách đơn chờ dự toán" /> */}
        ...
        <div className="mt-4 space-y-6 border border-gray-200 rounded-lg bg-white p-6 shadow-sm dark:border-none dark:bg-zinc-900 dark:shadow-2xl">
          <SearchToolbar
            ...
            reportTitle="Danh sách đơn chờ dự toán"
          />
          ...
          <DataTable columns={siteConfig.columnsWaitingBudget} data={mockData} searchQuery={searchQuery} />
