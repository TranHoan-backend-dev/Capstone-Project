...
import { MATERIAL_GROUP_COLUMN } from "@/config/table-columns";
import { GenericDataTable } from "@/components/ui/GenericDataTable";
import { CallToast } from "@/components/ui/CallToast";

export const MaterialGroupTable = ({
  filter,
  reloadKey,
  onEdit,
  onDeleted,
    ...
    const fetchData = async () => {
      try {
        ...
        const res = await fetch(
          `/api/device/materials-groups?${params.toString()}`,
        );
