...
public class ContractServiceImpl implements ContractService {
    ...
    public ContractResponse createContract(ContractRequest request) {
        ...
        WaterUsageContract contract = WaterUsageContract.create(builder -> builder
                .id(request.contractId())
                .customer(customer)
                .installationFormId(request.installationFormId())
                .representative(request.representatives()));

        WaterUsageContract saved = contractRepository.save(contract);
    ...
    public ContractResponse updateContract(String id, ContractRequest request) {
        ...
        WaterUsageContract contract = contractRepository.findById(id)
        ...
        WaterUsageContract updated = contractRepository.save(contract);
