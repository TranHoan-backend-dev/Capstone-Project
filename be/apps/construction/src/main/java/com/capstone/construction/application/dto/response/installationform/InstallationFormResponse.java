...
public record InstallationFormResponse(
  ...
  @Schema(description = "Customer address", example = "123 Main St") String address,

  @Schema(description = "Phone number", example = "0901234567") String phoneNumber,

  @Schema(description = "Timestamp when the form was created") LocalDateTime createdAt) {
}
