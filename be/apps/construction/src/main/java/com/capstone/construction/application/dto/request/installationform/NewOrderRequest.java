...
public record NewOrderRequest(
  ...
  @NotBlank(message = Message.PT_55)
  @NotEmpty(message = Message.PT_55)
  String receivedFormAt,

  @Schema(description = "Ngày dự kiến khảo sát (ISO)", example = "2024-02-05")
  @NotBlank(message = Message.PT_78)
  @NotEmpty(message = Message.PT_78)
  ...
  @NotBlank(message = Message.PT_62)
