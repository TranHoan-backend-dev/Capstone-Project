...
public class CalculationUnit {
  ...
  public static CalculationUnit create(@NonNull Consumer<CalculationUnitBuilder> consumer) {
  ...
  public static class CalculationUnitBuilder {
    private final CalculationUnit unit = new CalculationUnit();
