...
$$
  BEGIN
    ...
    VALUES ('BP-001', true, 'admin', 'Trang chủ', 'admin'),
           ('BP-002', true, 'admin', 'Lập hợp đồng cấp nước mới', 'admin'),
           ('BP-003', true, 'admin', 'Đơn lắp đặt mới', 'admin'),
           ('BP-004', true, 'admin', 'Tra cứu đơn lắp đặt mới', 'admin'),
           ('BP-005', true, 'admin', 'Tra cứu khách hàng', 'admin'),
           ('BP-006', true, 'admin', 'Khôi phục khách hàng hủy', 'admin'),
           ('BP-007', true, 'admin', 'Nhập khách hàng mới', 'admin'),
           ('BP-008', true, 'admin', 'Danh sách đơn chờ dự toán', 'admin'),
           ('BP-009', true, 'admin', 'Danh sách đơn chờ duyệt dự toán', 'admin'),
           ('BP-010', true, 'admin', 'Danh sách đơn từ chối duyệt dự toán', 'admin'),
           ('BP-011', true, 'admin', 'Danh sách đơn đã phân công khảo sát', 'admin'),
           ('BP-012', true, 'admin', 'Danh sách khách hàng gọi điện', 'admin'),
           ('BP-013', true, 'admin', 'Xử lý đơn chờ thiết kế & Thiết kế', 'admin'),
           ('BP-014', true, 'admin', 'Phân công khảo sát thiết kế', 'admin'),
           ('BP-015', true, 'admin', 'Duyệt dự toán', 'admin'),
           ('BP-016', true, 'admin', 'Chạy dự toán', 'admin'),
           ('BP-017', true, 'admin', 'Tra cứu dự toán', 'admin'),
           ('BP-018', true, 'admin', 'Quản lý mẫu bốc vật tư', 'admin'),
           ('BP-019', true, 'admin', 'Tra cứu quyết toán', 'admin'),
           ('BP-020', true, 'admin', 'Kiểm tra chỉ số bằng hình ảnh', 'admin'),
           ('BP-021', true, 'admin', 'Hồ sơ khách hàng', 'admin'),
           ('BP-022', true, 'admin', 'Trang chủ', 'admin');
