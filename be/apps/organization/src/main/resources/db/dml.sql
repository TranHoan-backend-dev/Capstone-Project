...
-- Job (30 records)
    ...
    VALUES ('2420a323-e180-4927-b956-654761026048', CURRENT_TIMESTAMP, 'Cấp quản lý xem báo cáo', CURRENT_TIMESTAMP),
           ...
           ('065842c2-8025-4c07-bc7e-976402422731', CURRENT_TIMESTAMP, 'Kỹ sư Thiết kế Kết cấu', CURRENT_TIMESTAMP),
           ('d8d21c38-8924-4061-827d-c36399996614', CURRENT_TIMESTAMP, 'Chuyên viên Đấu thầu', CURRENT_TIMESTAMP),
           ('56475704-5001-443b-a25e-e47573677461', CURRENT_TIMESTAMP, 'Trưởng phòng Thi công', CURRENT_TIMESTAMP),
           ('2060377b-665e-49b4-825e-d21820625406', CURRENT_TIMESTAMP, 'Đội trưởng Đội sản xuất', CURRENT_TIMESTAMP),
           ('09492160-c3d3-467a-b924-cc0985550c60', CURRENT_TIMESTAMP, 'Công nhân Kỹ thuật Bậc cao', CURRENT_TIMESTAMP),
           ('50212f45-0370-4322-a7d5-d14300329759', CURRENT_TIMESTAMP, 'Trưởng phòng Kinh doanh', CURRENT_TIMESTAMP),
           ('47585141-9496-4148-8df5-e1150495368a', CURRENT_TIMESTAMP, 'Chuyên viên Phát triển Thị trường', CURRENT_TIMESTAMP),
           ('0a082087-0b13-491b-b72e-848821958210', CURRENT_TIMESTAMP, 'Nhân viên Tư vấn Khách hàng', CURRENT_TIMESTAMP),
           ('0684277b-7b06-4475-8162-817651877607', CURRENT_TIMESTAMP, 'Chuyên viên Marketing Digital', CURRENT_TIMESTAMP),
           ('36526154-1296-4660-8488-842230006322', CURRENT_TIMESTAMP, 'Kế toán trưởng', CURRENT_TIMESTAMP),
           ('06085521-1221-4470-8255-888461741517', CURRENT_TIMESTAMP, 'Kế toán Tổng hợp', CURRENT_TIMESTAMP),
           ('96336688-2122-4462-8114-118833989911', CURRENT_TIMESTAMP, 'Nhân viên Hành chính Nhân sự', CURRENT_TIMESTAMP),
           ('55266155-5221-4471-8963-229944118822', CURRENT_TIMESTAMP, 'Chuyên viên Tuyển dụng', CURRENT_TIMESTAMP),
           ('44115599-2288-4433-7744-996633221144', CURRENT_TIMESTAMP, 'Nhân viên Pháp chế', CURRENT_TIMESTAMP),
           ('88552211-1144-4477-8855-663322114477', CURRENT_TIMESTAMP, 'Quản lý Dự án (PM)', CURRENT_TIMESTAMP),
           ('77441122-8855-4466-9966-332211445588', CURRENT_TIMESTAMP, 'Chuyên viên Quản lý Chất lượng (QA/QC)', CURRENT_TIMESTAMP),
           ('66332255-7744-4455-8844-551122336699', CURRENT_TIMESTAMP, 'Nhân viên Lễ tân', CURRENT_TIMESTAMP),
           ('55221144-8855-4422-7711-663322558800', CURRENT_TIMESTAMP, 'Nhân viên Thủ kho', CURRENT_TIMESTAMP),
           ('44115599-6633-4411-2288-112233445566', CURRENT_TIMESTAMP, 'Tài xế Văn phòng', CURRENT_TIMESTAMP),
           ('33224488-5522-4433-1177-889966554433', CURRENT_TIMESTAMP, 'Nhân viên Bảo vệ', CURRENT_TIMESTAMP);
  END
$$;
