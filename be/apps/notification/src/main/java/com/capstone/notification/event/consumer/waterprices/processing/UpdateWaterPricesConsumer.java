...
// import
// com.capstone.notification.event.consumer.waterprices.message.UpdateEventMessage;
...
// @Component
// public class UpdateWaterPricesConsumer extends
// GeneralEventConsumer<UpdateEventMessage> {
...
// "${rabbit-mq-config.queue}.${rabbit-mq-config.entities[10]}.${rabbit-mq-config.update}")
...
// - Mô tả: %s
// """.formatted(
// data.oldUserTarget(), data.oldTax(), data.oldEnvironmentPrice(),
// data.oldApplicationPeriod(), data.oldDescription(),
// data.newUserTarget(), data.newTax(), data.newEnvironmentPrice(),
// data.newApplicationPeriod(), data.newDescription()
// );
// }
// }
