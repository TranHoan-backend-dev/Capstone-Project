...
import com.capstone.notification.event.consumer.calculationunit.message.UpdateParameterEventMessage;
...
@Component
public class UpdateParameterConsumer extends GeneralEventConsumer<UpdateParameterEventMessage> {
    ...
    public void handle(UpdateParameterEventMessage event) {
    ...
    @Override
    protected String buildMessage(@NonNull UpdateParameterEventMessage event) {
        var data = event.data();
